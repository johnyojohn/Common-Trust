...
export {
  addCommentToUser, addCommentToPost, addPostToClass,
  addPostToUser, addUserToClasses, addInstructorToClass,
  addInstructorToClasses, addClassToUser, addUserToClass,
};
